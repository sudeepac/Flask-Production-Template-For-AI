...
from app.utils.error_handlers import (
    ...
    ConflictAPIError, ServiceUnavailableAPIError
)
from app.utils.logging_config import get_logger, log_security_event, PerformanceLogger
...
class ExampleService:
            ...
            try:
                ...
                if self._slug_exists(slug):
                    ...
                    raise ConflictAPIError(
                        ...
                        {"slug": slug, "suggested_slug": f"{slug}-{int(datetime.utcnow().timestamp())}"}
                    )
    ...
    def _validate_post_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        class PostSchema(Schema):
            ...
            status = fields.Str(missing="draft", validate=lambda x: x in ['draft', 'published'])
    ...
    def _create_post_transaction(self, data: Dict[str, Any], slug: str, user_id: Optional[int]) -> Post:
