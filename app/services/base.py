...
class BaseMLService(abc.ABC):
    ...
    def predict(self, data: Union[Dict, List[Dict]], 
                use_cache: bool = None) -> Union[Dict, List[Dict]]:
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            status = 'healthy' if (model_exists and model_loaded and test_prediction_ok) else 'unhealthy'
