...
readiness_model = health_ns.model('ReadinessCheck', {
...
liveness_model = health_ns.model('LivenessCheck', {
...
class DetailedHealthCheckResource(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            memory_usage_percent = (memory_usage_mb / (memory_usage_mb + available_mb)) * 100
        ...
        logger.info(f"Detailed health check completed", extra={
            'status': overall_status,
...
class ReadinessCheckResource(Resource):
    ...
    def get(self):
        ...
        logger.info(f"Readiness check completed", extra={
            'ready': ready,
