...
from app.schemas.v2.base import BaseSchema, TimestampMixin, MetadataMixin
...
class MetadataSchema(BaseSchema, MetadataMixin):
    ...
    method = fields.Str(dump_only=True, validate=validate.OneOf([
...
class ValidationErrorSchema(ErrorSchema):
    ...
    @post_load
    def structure_validation_error(self, data: Dict[str, Any], **kwargs) -> Dict[str, Any]:
...
def create_success_response(message: str = 'Success', data: Optional[Dict] = None,
