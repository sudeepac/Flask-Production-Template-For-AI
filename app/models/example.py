...
class User(BaseModel):
    ...
    )  # In real app, this would be required
    ...
    def to_dict(
        self, include_relationships: bool = False, include_sensitive: bool = False
    ) -> dict:
...
class Post(BaseModel):
    ...
    def get_published(cls) -> list:
        ...
        """
        return (
            cls.query.filter_by(status="published")
    ...
    def get_featured(cls) -> list:
        ...
        """
        return (
            cls.query.filter_by(is_featured=True).order_by(cls.created_at.desc()).all()
        )
