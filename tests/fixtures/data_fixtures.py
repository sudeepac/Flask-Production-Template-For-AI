...
def mock_ml_model():
    ...
    class MockMLModel:
        ...
        def get_feature_importance(self):
            return {"feature1": 0.4, "feature2": 0.35, "feature3": 0.25}
...
def sample_json_data():
    ...
    return {
        "simple_object": {"name": "Test Object", "value": 42, "active": True},
        "nested_object": {
            "user": {
                "id": 1,
                "profile": {
        ...
        "array_data": {
            ...
            "metadata": {"total": 3, "type": "test_items"},
        },
        "complex_data": {
            "timestamp": datetime.datetime.utcnow().isoformat(),
            "coordinates": [40.7128, -74.0060],
            "tags": ["test", "sample", "data"],
            "config": {"enabled": True, "max_retries": 3, "timeout": 30.0},
        },
    }
...
def mock_external_service():
    ...
    class MockExternalService:
        def __init__(self):
            ...
            self.responses = {"default": {"status": "success", "data": "mock response"}}
...
def sample_error_scenarios():
    ...
    return {
        "validation_errors": {
            ...
            "invalid_format": {"field": "email", "message": "Invalid email format"},
            "value_too_long": {
                "field": "username",
...
def performance_test_data():
    ...
    return {
        ...
        "concurrent_users": {"light_load": 10, "medium_load": 50, "heavy_load": 100},
        "request_patterns": {
