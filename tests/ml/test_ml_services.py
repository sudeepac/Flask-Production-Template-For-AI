...
class TestMLModelService:
    ...
    def test_model_training(self, mock_sklearn_model, sample_training_data):
        ...
        assert len(trained_model.feature_names_in_) == sample_training_data['n_features']
    
    def test_model_prediction(self, mock_sklearn_model, sample_training_data, sample_prediction_data):
    ...
    def test_model_prediction_probabilities(self, mock_sklearn_model, sample_training_data, sample_prediction_data):
...
class TestMLDataProcessing:
    ...
    def test_feature_engineering(self, sample_dataframe):
        ...
        df['feature_4_binned'] = pd.cut(df['feature_4'], bins=3, labels=['low', 'medium', 'high'])
...
class TestMLModelEvaluation:
    ...
    def test_cross_validation_simulation(self, mock_sklearn_model, sample_training_data):
