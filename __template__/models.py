...
class Template(db.Model, TimestampMixin, UUIDMixin):
    ...
    __table_args__ = {
        'comment': 'Template entities for reusable components'
    }
    ...
    tags = Column(
        JSON,
        nullable=True,
        comment='Template tags as JSON array'
    )
    ...
    configuration = Column(
        JSON,
        nullable=True,
        comment='Template configuration as JSON'
    )
    ...
    @classmethod
    def search(cls, query: str, category: Optional[str] = None, 
               tags: Optional[List[str]] = None, is_active: Optional[bool] = None) -> List['Template']:
        """Search templates.
