...
def run_security_checks(args):
    ...
    cmd = [sys.executable, '-m', 'bandit', '-r', 'app/', '-f', 'json', '-o', 'reports/bandit_report.json']
    run_command(cmd)
    
    # Run safety
    print("\nChecking dependencies for known vulnerabilities...")
    cmd = [sys.executable, '-m', 'safety', 'check', '--json', '--output', 'reports/safety_report.json']
    run_command(cmd)
...
Examples:
  ...
  python run_tests.py --clean                   # Clean test artifacts
    ...
    quality_group.add_argument('--lint', action='store_true', help='Run linting and formatting checks')
    quality_group.add_argument('--security', action='store_true', help='Run security checks')
    
    # Options
    options_group = parser.add_argument_group('Options')
    options_group.add_argument('--coverage', action='store_true', help='Generate coverage report')
    options_group.add_argument('--parallel', action='store_true', help='Run tests in parallel')
    options_group.add_argument('--benchmark', action='store_true', help='Run benchmark tests')
    options_group.add_argument('--html-report', action='store_true', help='Generate HTML test report')
    options_group.add_argument('--json-report', action='store_true', help='Generate JSON test report')
    options_group.add_argument('--markers', type=str, help='Pytest markers to filter tests')
    
    # Utility commands
    utility_group = parser.add_argument_group('Utilities')
    utility_group.add_argument('--setup', action='store_true', help='Setup test environment')
    utility_group.add_argument('--report', action='store_true', help='Generate comprehensive test report')
    utility_group.add_argument('--clean', action='store_true', help='Clean test artifacts')
